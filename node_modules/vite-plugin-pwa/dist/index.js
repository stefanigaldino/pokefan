...
async function generateInjectManifest(options, viteOptions) {
  ...
  const [workbox, buildSW] = await Promise.all([
    loadWorkboxBuild(),
    import("./vite-build-WSVX5QNQ.js").then(({ buildSW: buildSW2 }) => buildSW2)
  ]);
...
function _generateBundle({ options, viteConfig, useImportRegister }, bundle) {
